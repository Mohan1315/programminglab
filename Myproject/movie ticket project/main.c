...
int movie(void)
{
	...
	printf("\t\t\t----------------------------\n\n");
	printf("\t\t\tpress 1 for 3 Idiots (Engineering Life)\n\n");
	printf("\t\t\tpress 2 for Lakshya \n\n");
	printf("\t\t\tpress 3 for Story of Mohan: A Engineer Student\n");
	scanf("%d",&i);
	system("cls");
	return i;
}
int cmovie(void)
{
	...
	printf("\t\t\tpress 1 for 3 Idiots (Engineering Life)\n\n");
	printf("\t\t\tpress 2 for Lakshya\n\n");
	printf("\t\t\tpress 3 for Mohan: A Engineer Student\n");
	scanf("%d",&i);
	return i;		
}
void ticket1(int choice,char name[10],int id2,int price)
