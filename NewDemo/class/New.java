...
class ElectronicProduct extends Product {
    ...
    public void display() {
        System.out.println(
                getName() + " by " + brand + " - Rs." + getPrice() + " x " + getQuantity() + " = Rs."
                        + calculateTotal());
    }
...
class GroceryProduct extends Product {
    ...
    public GroceryProduct(String name, double price, String brand) {
        super(name, price);
        this.brand = brand;
    }
...
class FashionProduct extends Product {
    ...
    public FashionProduct(String name, double price, String brand) {
        super(name, price);
        this.brand = brand;
    }
...
class SportsProduct extends Product {
    ...
    public SportsProduct(String name, double price, String brand) {
        super(name, price);
        this.brand = brand;
    }
